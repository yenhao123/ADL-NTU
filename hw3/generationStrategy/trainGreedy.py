...
def main():
    ...
    #trainFilePath,evalFilePath = dataPreprocessed(args)
    ...
    def preprocess_function(examples):
        ...
        inputs_ids = tokenizer(inputs, max_length=args.max_source_length, padding=padding, truncation=True,return_tensors="pt")
        print(inputs_ids)
        print(len(inputs_ids["input_ids"][0]))

        #Greedy Decoding
        model_inputs = model.generate(
    ...
    with open("lossANDmetric/train/result.json","w") as f:
        json.dump(results,f,ensure_ascii=False)
